(function($) {
  $.fn.mauGallery = function(options) {
    ...
    return this.each(function() {
      ...
      $(this).find(".gallery-item img").each(function() {
        ...
        $.fn.mauGallery.methods.moveItemInRowWrapper($(this).parent());
        $.fn.mauGallery.methods.wrapItemInColumn($(this).parent(), options.columns);
  ...
  $.fn.mauGallery.methods = {
    ...
    prevImage() {
      let activeImage = $("img.gallery-item[src='" + $(".lightboxImage").attr("src") + "']");
